...
function Button(props: ButtonProps) {
  ...
  return (
    ...
    <button
      onClick={onClick}
      className={classNames("px-2 cursor-pointer shadow-none text-sm", className, {
        ...
        " bg-red-600 text-white border-none  hover:bg-red-400" : variant === "warning" ,
    ...
    >
      ...
      {loading && 
      <div className=
      {classNames("w-2 h-2 border-2 border-solid border-primary border-t-transparent animate-spin rounded-full",
        {
